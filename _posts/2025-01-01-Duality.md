...
<style>
  ...
  * {
  ...
  /* Strict control of html and body */
  html {
  ...
  /* Hide all default theme elements */
  ...
  /* Custom footer with absolute positioning */
  .custom-footer {
  ...
  .content-container {
    ...
    min-height: calc(100% - 50px); /* Account for nav bar */
...
<div class="nav-buttons">
  ...
  <button class="nav-button" onclick="window.location.href='/research'">Research</button>
</div>
