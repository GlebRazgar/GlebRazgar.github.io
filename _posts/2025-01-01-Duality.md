...
.step-icon {
  ...
  .funding-container {
    ...
    border-radius: 20px;
    padding: 50px 40px;
    margin: 120px auto 49px auto; /* Reduced bottom margin by another 10% from 54px to 49px */
    max-width: 690px; /* Increased by 5% from 660px to 690px */
    text-align: center;
    overflow: hidden;
  ...
  @media (max-width: 768px) {
    .funding-container .funding-content h2.funding-title {
      font-size: 3rem !important; /* Smaller size on mobile but still larger than before */
    }
  }
...
<div class="mission-section">
  <div class="mission-content">
    ...
    <div class="section-content">
      ...
      <p>We are attempting to solve this by mapping the first human brain at nano-scale resolution, and turn it into a human simulation.</p>

      Our work aims to unlock new forms of mecicine: from simulation of brain diseases, emulation of new drug treatments to development of human-like AI models.
    </div>
  </div>
</div>
