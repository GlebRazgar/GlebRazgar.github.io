...
<div class="centered-section process-section">
  ...
  <div class="process-timeline-container">
    ...
    <div class="step-icon step-icon-1">
      <img src="/images/dollar.svg" width="140.625" height="140.625" alt="Dollar icon" style="fill: #5ED464; display: block; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    </div>
    
    <div class="step-icon step-icon-2">
      <img src="/images/idea.svg" width="140.625" height="140.625" alt="Idea icon" style="fill: #5ED464; display: block; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    </div>
    
    <div class="step-icon step-icon-3">
      <img src="/images/rocket.svg" width="140.625" height="140.625" alt="Rocket icon" style="fill: #5ED464; display: block; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    </div>
  </div>
