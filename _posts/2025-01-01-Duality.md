...
<div class="centered-section">
  ...
  <div class="backing-boxes">
    <div class="backing-box">
      <div class="backing-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="#5ED464">
          <circle cx="10" cy="10" r="6" stroke="#5ED464" fill="none" stroke-width="2"/>
          <line x1="14.5" y1="14.5" x2="20" y2="20" stroke="#5ED464" stroke-width="2"/>
        </svg>
      </div>
      <div class="backing-title">Scan</div>
      <div class="backing-text">
        To create a digital replica of the brain, we image it at nano-meter resolution - capturing structural features down to a synapse. 
      </div>
    ...
    <div class="backing-box">
      <div class="backing-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="#5ED464">
          <path d="M4,4h2v2H4V4z M8,4h2v2H8V4z M12,4h2v2h-2V4z M16,4h4v4h-4V4z M4,8h4v4H4V8z M10,10h4v4h-4V10z M16,8h2v2h-2V8z M20,8h2v2h-2V8z M4,14h2v2H4V14z M8,14h2v2H8V14z M12,14h2v2h-2V14z M16,14h4v4h-4V14z M20,12h2v2h-2V12z M20,16h2v2h-2V16z M4,18h4v4H4V18z M10,18h4v4h-4V18z M16,18h2v2h-2V18z M20,20h2v2h-2V20z"/>
        </svg>
      </div>
    ...
    <div class="backing-box">
      <div class="backing-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="#5ED464">
          <path d="M4,12 Q8,6 12,12 T20,12" stroke="#5ED464" fill="none" stroke-width="2"/>
          <circle cx="20" cy="12" r="2" fill="#5ED464"/>
        </svg>
      </div>
      ...
      <div class="backing-preference">
        ...
        <div class="preference-qualities">
          <div class="quality-option">Disieses</div>
