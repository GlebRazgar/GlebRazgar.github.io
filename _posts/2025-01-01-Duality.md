...
<style>
  ...
  /* Custom footer styling with green accents */
  .custom-footer {
    background-color: black;
    color: white;
    padding: 30px 0;
    margin-top: 60px;
    border-top: 1px solid #5ED464; /* Changed to green border */
    text-align: center;
    width: 100%;
  }
  ...
  .footer-link:hover {
    color: #5ED464; /* Already green on hover */
  }
