...
<div class="centered-section">
  ...
  <div class="backing-boxes">
    <div class="backing-box">
      <div class="backing-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="#5ED464">
          <path d="M9.5,14.5c-2.76,0-5-2.24-5-5s2.24-5,5-5s5,2.24,5,5S12.26,14.5,9.5,14.5z M9.5,6.5c-1.65,0-3,1.35-3,3s1.35,3,3,3 s3-1.35,3-3S11.15,6.5,9.5,6.5z"/>
          <path d="M14,15.5l2.25,2.25c0.29,0.29,0.77,0.29,1.06,0l2.25-2.25c0.44-0.44,0.44-1.15,0-1.59L17.3,11.6 c-0.44-0.44-1.15-0.44-1.59,0L14,13.91C13.56,14.35,13.56,15.06,14,15.5z"/>
        </svg>
      </div>
      <div class="backing-title">Scan</div>
      <div class="backing-text">
        Text: To create a near-identical digital reconstruction of the brain, we image it at nan-meter resolution to capture structure down to each synapse. 
      </div>
    ...
    <div class="backing-box">
      <div class="backing-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="#5ED464">
          <path d="M4,4h4v4H4V4z M10,4h4v4h-4V4z M16,4h4v4h-4V4z M4,10h4v4H4V10z M10,10h4v4h-4V10z M16,10h4v4h-4V10z M4,16h4v4H4V16z M10,16h4v4h-4V16z M16,16h4v4h-4V16z"/>
        </svg>
      </div>
      <div class="backing-title">Digitize</div>
      <div class="backing-text">
        We then convert the imaging data into a structural reconstruction of the brain.
      </div>
      <div class="backing-preference">
    ...
    <div class="backing-box">
      <div class="backing-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" fill="#5ED464">
          <path d="M4,9h16v2H4V9z M4,13h16v2H4V13z"/>
        </svg>
      </div>
      <div class="backing-title">Simulate</div>
      <div class="backing-text">
        Lastly - we make sure the digital brain is functionally identical to the original and can be simulated in any environemnt.
      </div>
      <div class="backing-preference">
...
<div class="centered-section process-section">
  ...
  <div class="process-timeline-container">
    ...
    <div class="timeline-item left">
      ...
      <div class="step-description">We are raising $500k pre-seed in vein of uploading the first human brain</div>
    </div>
    ...
    <div class="timeline-item left">
      ...
      <div class="step-description">Scale our technology platform and licence it to companies and labs. </div>
    </div>
