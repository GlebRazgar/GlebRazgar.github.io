...
<div class="header-title-container" style="text-align: center; margin-top: 100px; margin-bottom: 60px; position: relative; height: 300px;">
  ...
  <!-- Subtitle slogan -->
  <h2 class="header-subtitle" style="font-family: Helvetica, Arial, sans-serif; color: #5ED464; position: absolute; width: 100%; bottom: 50px; opacity: 0; font-weight: 300; font-size: 1.5rem;">Human brain uploading</h2>
</div>
    ...
    function animate() {
      ...
      if (allArrived) {
        ...
        finalImage.onload = function() {
          ...
          setTimeout(function() {
            subtitleElement.style.transition = 'opacity 0.25s ease';
