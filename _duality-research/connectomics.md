...
Our brain — the crown jewel of consciousness — is poorly understood, and even more poorly cured. The brain can be described as a function. One that is dependent on its temporal dynamics, neuronal activations, and synaptic weights. As you could imagine, being able to model or "upload" such a function would be **UNPRECEDENTED**. To model the brain is to "upload" it, and uploading the brain gives us the ability to simulate **brain diseases**, **drug development**, **intelligence**, and possibly one day **<u>consciousness</u>**.  
