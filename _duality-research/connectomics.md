...
As sci-fi as I make it sound, connectomics is anything but fiction. Connectomics researchers having already "uploaded" small insects and animals at nanometer imaging resolution. At the rate of current progress, human connectome will follow within the **next few years**. The world with human brain emulations looks starkly different to todays - which motivates this post to provide a holistic overview of connectomics, its methods, and upcoming directions.
